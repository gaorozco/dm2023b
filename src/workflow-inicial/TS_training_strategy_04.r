...
PARAM$final_train <- c(
  ...
  202010, 202009, 202008, 202001, 201912,
  201911, 201910, 201909, 201908, 201907
)

PARAM$train$training <- c(
  202107, 202104, 202101, 202012, 202011, 202010, 202009, 202008, 202001, 201912, 
  201911, 201910, 201909, 201908, 201907, 201906, 201905, 201904
)

PARAM$train$validation <- c(202105, 202102)
PARAM$train$testing <- c(202108, 202106, 202103)
...
PARAM$train$semilla <- 100023 # cambiar por su propia semilla  !!!
